            ...
            if ($request->ajax()) {
                ...
                return Datatables::of($data)
                    ...
                    ->addColumn('action', function ($data) use ($user) {
                        ...
                        if ($user->hasRole('admin') || $user->hasRole('company') || auth()->user()->hasRole('user')) {
                            $btn .= '<button value="edit" data-id="' . $data->id . '" class="project_details btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                        ...
                        if ($user->hasRole('admin')) {
                            $btn .= '<button value="genqrcode" data-id="' . $data->id . '" class="project_details btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
