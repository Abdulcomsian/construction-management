...
class DesignerController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $designer_certificate=DesignerCertificate::where('temporary_work_id',$id)->get();
...
//duplicated get_desings for fetching twd names
   ...
   public function allHistory(Request $request){
    $id=\Crypt::decrypt($request->id);
    $invoiceHistoryData = ChangeEmailHistory::where('foreign_idd', $id)->get(); // gettting the all type of data
    $list = '';
    $i = 1;
