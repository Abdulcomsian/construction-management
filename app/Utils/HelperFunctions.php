...
class HelperFunctions
{
    ...
    {
        $count = TemporaryWork::withTrashed()->where(['project_id'=>$project_id])->count(); //,'estimator'=>0 Abdul remove this from where condition because it was repeating twc id no when we were moving it from pre con to temporary work register
        $count = $count + 1;
