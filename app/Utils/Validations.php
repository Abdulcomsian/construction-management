...
class Validations
{
    ...
    public static function storescaffolding($request)
    {
        $request->validate([
            ...
            'tws_name' => ['required'],
            // 'ms_ra_no' => ['required'],
            'equipment_materials_desc' => 'required_if:equipment_materials,1',
            'workmanship_desc' => 'required_if:workmanship,1',
            'drawings_design_desc' => 'required_if:drawings_design,1',
            'loading_limit_desc' => 'required_if:loading_limit,1',
