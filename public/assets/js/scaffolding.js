...
$('input[name="equipment_materials"]').change(function () {
    if ($(this).val() == 2) {
        ...
        $('textarea[name="equipment_materials_desc"]').addClass('d-none').removeAttr("required");
    }
});
...
$('input[name="workmanship"]').change(function () {
    if ($(this).val() == 2) {
        ...
        $('textarea[name="workmanship_desc"]').addClass('d-none').removeAttr("required");
    }
});
...
$('input[name="loading_limit"]').change(function () {
    if ($(this).val() == 2) {
        ...
        $('textarea[name="loading_limit_desc"]').addClass('d-none').removeAttr("required");
    }
});
...
$('input[name="drawings_design"]').change(function () {
    if ($(this).val() == 2) {
        ...
        $('textarea[name="drawings_design_desc"]').addClass('d-none').removeAttr("required");
    }
});
