...
const PDFViewerApplication = {
    ...
    async initialize(appConfig) {
        ...
        if (
            ...
            this._nimbusDataPromise =
                this.externalServices.getNimbusExperimentData();
        }
...
if (typeof PDFJSDev === "undefined" || PDFJSDev.test("GENERIC")) {
    ...
    var webViewerFileInputChange = function (evt) {
        ...
        const selectedFileUrl = localStorage.getItem("selectedPDFPath");
        ...
        fetch(selectedFileUrl)
            .then((response) => {
                ...
                return response.blob(); // Use response.blob() to get the file content as a Blob
            })
            .then((blob) => {
                let metadata = {
                ...
                linkElement.download = file.name; // Set the desired filename for the downloaded file
                // Trigger the download by simulating a click on the link
                linkElement.click();

                PDFViewerApplication.open({
                    url: objectURL,
                    originalUrl: selectedFileUrl,
                });
            })
            .catch((error) => {
