            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title list_top" style="width:98%">
                        <h2 class="db_mr" style="display: inline-block;">Edit Job Design Brief</h2>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex inputDiv d-block mb-0">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" name="date" value="<?php if(isset($temporaryWork->date)){ echo $temporaryWork->date; }else{echo date('d/m/Y');} ?>"
