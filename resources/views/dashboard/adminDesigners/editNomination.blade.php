@extends('layouts.nomination',['title' => 'Edit Nomination'])
@section('styles')
<style>
   <style>
                               ...
                               <table class="table nom_table mt-0 table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="print_name" value="{{date('Y-m-d')}}"></td>
                                        </tr>
                                        <tr>
