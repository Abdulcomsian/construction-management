@extends('layouts.dashboard.master',['title' => 'Admin Suppliers List'])
@section('styles')
<style>
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1" style="width: 100%; text-align: center;">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-3" style="width: 100%; text-align: center;">Admin Suppliers List</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <!--begin::Card toolbar-->
                     @if(\Auth::user()->hasRole(['admin']))
                      <a href="{{ url('adminSupplier/create') }}" value="add" class="newDesignBtn btn">Add Supplier</a>
                     @endif
                    <!--end::Card toolbar-->
                </div>
                <!--end::Card header-->
