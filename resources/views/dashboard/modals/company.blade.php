                ...
                <form id="kt_modal_new_target_form" class="form project_details_form" action="{{ route('projects.store') }}" method="post">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="number" class="form-control form-control-solid" placeholder="Company Name" name="no" value="{{old('no')}}"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-bold mb-2">Company Email</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Company Email" name="name" value="{{old('name')}}"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <div class="row g-9 mb-8">
