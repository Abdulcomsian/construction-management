        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <div class="multi-list">
                    ...
                    <div class="common-requirment requirment-second" style="display: block !important">
                        <input type="text" vlaue="" class="requirment-second-value">
                        <div class="list-div">
                            ...
                            <ul>
                                ...
                                <li class="{{$temporaryWork->scopdesign->specifications_date_sod ? '':'invisible'}} Specifications">
                                    <input type="date" name="specifications_date_sod" value="{{$temporaryWork->scopdesign->specifications_date_sod ?? '' }}">
                                </li>
                                <li class="{{$temporaryWork->scopdesign->design_inspection_test_plans_date_sod ? '':'invisible'}} Design-Inspection">
                                    <input type="date" name="design_inspection_test_plans_date_sod" value="{{$temporaryWork->scopdesign->design_inspection_test_plans_date_sod ?? '' }}">
                                </li>
                ...
                <div class="multi-list">
                    <div class="common-requirment requirment-first">
                        ...
                        <div class="list-div">
                            <ul>
                                ...
                                <li class="limitations_on_temporary_works_design_comment {{$temporaryWork->attachspeccomment->limitations_on_temporary_works_design_comment ?'':'d-none'}}">
                                    <textarea style="background: black;color:white;ay:none" type="text" name="limitations_on_temporary_works_design_comment" cols="80" rows="2" placeholder="Enter Comment">{{$temporaryWork->attachspeccomment->limitations_on_temporary_works_design_comment ?? ''}}</textarea>
                                </li>
                                ...
                                <li class="details_of_any_hazards_comment {{$temporaryWork->attachspeccomment->details_of_any_hazards_comment ?'':'d-none'}}">
                                    <textarea style="background: black;color:white;ay:none" type="text" name="details_of_any_hazards_comment" cols="80" rows="2" placeholder="Enter Comment">{{$temporaryWork->attachspeccomment->details_of_any_hazards_comment ?? ''}}</textarea>
                                </li>
                    ...
                    <div class="common-requirment requirment-second" style="display: block !important">
                        <div class="list-check-div">
                            <ul>
                                <li class="{{$temporaryWork->folder->list_of_attachments ? '':'invisible'}} List-Attachment">
                                    <div class="multi-Radio">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="list_of_attachments_folder" id="flexRadioDefault1" value="yes" {{$temporaryWork->folder->list_of_attachments=='yes' ? 'checked':''}}/>
                                        ...
                                        <!-- NO -->
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="list_of_attachments_folder" id="flexRadioDefault2" value="no" {{$temporaryWork->folder->list_of_attachments=='no' ? 'checked':''}}/>
                                ...
                                <li class="{{$temporaryWork->folder->reports_including_site_investigations ? '':'invisible'}} Report-Site">
                                    <div class="multi-Radio">
                                        ...
                                        <!-- NO -->
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="reports_including_site_investigations_folder" id="flexRadioDefault2" value="no" {{$temporaryWork->folder->reports_including_site_investigations=='no' ? 'checked':''}}/>
                                            <label class="form-check-label" for="flexRadioDefault2"> NO </label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="{{$temporaryWork->folder->existing_ground_conditions ? '':'invisible'}} Exsisting-Ground">
                                    <div class="multi-Radio">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="existing_ground_conditions_folder" id="flexRadioDefault1" value="yes" {{$temporaryWork->folder->existing_ground_conditions=='yes' ? 'checked':''}}/>
                                        ...
                                        <!-- NO -->
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="existing_ground_conditions_folder" id="flexRadioDefault2" value="no" {{$temporaryWork->folder->existing_ground_conditions=='no' ? 'checked':''}}/>
                                            <label class="form-check-label" for="flexRadioDefault2"> NO </label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="{{$temporaryWork->folder->preferred_non_preferred_methods ? '':'invisible'}} System-Type">
                                    <div class="multi-Radio">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="preferred_non_preferred_methods_folder" id="flexRadioDefault1" value="yes" {{$temporaryWork->folder->preferred_non_preferred_methods=='yes' ? 'checked':''}}/>
                                        ...
                                        <!-- NO -->
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="preferred_non_preferred_methods_folder" id="flexRadioDefault2" value="no" {{$temporaryWork->folder->preferred_non_preferred_methods=='no' ? 'checked':''}}/>
                                            <label class="form-check-label" for="flexRadioDefault2"> NO </label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="{{$temporaryWork->folder->access_limitations ? '':'invisible'}} Limitations">
                                    <div class="multi-Radio">
                                        ...
                                        <!-- NO -->
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="access_limitations_folder" id="flexRadioDefault2" value="no" {{$temporaryWork->folder->access_limitations=='no' ? 'checked':''}}/>
                                            <label class="form-check-label" for="flexRadioDefault2"> NO </label>
                                        </div>
                                    </div>
                                </li>
