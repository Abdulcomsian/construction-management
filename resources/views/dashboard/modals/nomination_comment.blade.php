    ...
    <div class="modal-dialog modal-dialog-centered mw-1000px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-0 border-0 ">
                ...
                <div style="width:100%;">
                    <h6 style="margin-left: 20px">
                        Please confirm acceptance once you have reviewed nomination. To view nomination please <a
                            href="{{asset('pdf').'/'.$nomination->pdf_url}}">click here</a>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15 mt-5">
                ...
                <form id="desingform" action="{{url('Nomination/nomination-chagnestatus')}}" method="post"
                                ...
                                <div class="d-flex inputDiv my-3" id="sign">
                                    ...
                                    <div class="d-flex inputDiv">
                                        ...
                                        <span id="clear" class="fa fa-undo cursor-pointer"
                                            style="line-height: 11"></span>
                                    </div>


                                </div>
                                <span style="font-size:12px">This signature will be used in the appointment letter which
                                    will be sent upon acceptance.</span>
