    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Edit Supplier</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-solid" placeholder="Supplier Name" name="name" value="{{old('name') ?: $user->name}}" />
                                </div>
                                <div class="col-md-6">
                                    <label class="required fs-6 fw-bold mb-2">Supplier Email</label>
                                    <input type="email" class="form-control form-control-solid" placeholder="Supplier Email" name="email" value="{{old('email')  ?: $user->email}}" />
                                </div>
