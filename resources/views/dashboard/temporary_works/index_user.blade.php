                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td >
                                        ...
                                        <span data-id="{{$item->id}}" class="addcomment cursor-pointer" style="background: blue;color: white;font-weight: bold;padding: 0 10px;">{{count($item->comments)+count($item->scancomment ?? '')}}</span>
