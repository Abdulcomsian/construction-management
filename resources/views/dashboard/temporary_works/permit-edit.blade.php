            ...
            <div class="card-body pt-0">
                <form id="permitrenew" action="{{route('permit.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col">
                            <div class="d-flex inputDiv d-block mb-0">
                                ...
                                <select name="project_id" id="projects" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" readonly>
                                    ...
                                    <option value="@isset($project){{$project->id}}@endisset" selected="selected">@isset($project){{$project->name .' - '.
                                        $project->no}}@endisset</option>
                                </select>
                            </div>
                        </div>
                    </div>
                             ...
                             <div class="d-flex justify-content-between mb-3 requiredDiv">
                                ...
                                <div style="flex-shrink: 0;">
                                  ...
                                  <label style="border-radius: 3px">
                                    <input type="radio" class="btn-check minimum_concrete" name="minimum_concrete" value="1" @if(isset($permitdata) && $permitdata->minimum_concrete == 1){{'checked'}}@endif/>
                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4" style="border-radius: 3px; ">Y</span>
                                  </label>
                                  <!--end::Option-->
                                  <!--begin::Option-->
                                  <label>
                                    <input type="radio" class="btn-check minimum_concrete" name="minimum_concrete" value="2" @if(isset($permitdata) && $permitdata->minimum_concrete == 2){{'checked'}}@endif/>
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2" id="second_member">
                            <div class="col" style="flex:100% !important;">
                                ...
                                <div class="d-flex inputDiv ">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control" placeholder="Name" name="name" value="{{$permitdata->name ?? ''}}" {{ isset($permitdata->name) && $permitdata->name != null ? 'readonly' : '' }}>
                                </div>
                                <div class="d-flex inputDiv ">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <div class="d-flex inputDiv ">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" id="companyadmin" class="form-control" placeholder="Company" name="company" value="{{$project->company->name ?? ''}}" {{ isset($project->company->name) && $project->company->name != null ? 'readonly' : '' }}>
                        ...
                        <div class="col-md-6 mt-15" id="third_member" style="display: {{ isset($permitdata->signatures[0]->name) && $permitdata->signatures[0]->name != null ? 'block' : 'none' }}">
                        ...
                        <div class="col-md-6 mt-15" id="fourth_member" style="display: {{ isset($permitdata->signatures[1]->name) &&      $permitdata->signatures[1]->name != null ? 'block' : 'none' }}">
                            <div class="d-flex inputDiv principleno mt-0">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                    <span class="required">Name:</span>
                        ...
                        <div class="col-md-6 mt-15" id="fifth_member" style="display: {{ isset($permitdata->signatures[2]->name) && $permitdata->signatures[2]->name != null ? 'block' : 'none' }}">
                            <!-- <div class="d-flex inputDiv d-block">
                                                </div> -->
                            <div class="d-flex inputDiv principleno mt-0">
                                <!--begin::Label-->
