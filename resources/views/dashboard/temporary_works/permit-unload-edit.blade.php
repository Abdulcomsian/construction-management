    ...
    <div id="kt_content_container" class="container unload_Permit">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <form id="permitunload" action="{{route('permit.unload.update')}}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="modalDiv d-block mt-md-11" id="drawingFieldDiv">
                                ...
                                <select id="drawingDropDown" class="form-select" name="drawing"
                                    style="border-radius: 9px;">
                                    <option value="">Select PDF</option>
                                    @foreach($temporary_work_files as $upload)
                                    <option value="{{ env('APP_URL').$upload->file_name }}">
                                        {{ $upload->drawing_number }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-6" id="customFieldDiv">
                            <div class="modalDiv d-block mt-md-11">
                                ...
                                <!--end::Label-->
                                <input type="file" style="border-radius: 9px;" class="form-control" id="custom_drawing"
                                    name="custom_drawing" value="" accept="image/*;capture=camera">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="new_div" class="m-md-2">
                                ...
                                <span id="{{$value}}">
                                    ...
                                    <button type="button" onclick="deletePDFFile('{{$value}}', '{{$permitdata->id}}')"
                                        class="remove-file btn btn-danger btn-sm"
                                        data-filename="{{$value}}">&times;</button>
                                </span>
                                @endforeach
                                @endif
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-right:28px">
                                            <input type="text" name="mix_design_detail"
                                                ...
                                                value="{{$permitdata->mix_design_detail ?? ''}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-right:28px">
                                            <input type="text" name="unique_ref_no"
                                                ...
                                                value="{{$permitdata->unique_ref_no ?? ''}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-right:28px">
                                            <input type="text" name="age_cube"
                                                class="form-control form-control-solid tableinput"
                                                placeholder="Enter Age of Cube" value="{{$permitdata->age_cube ?? ''}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-right:28px">
                                            <input type="text" name="compressive_strength"
                                                ...
                                                value="{{$permitdata->compressive_strength ?? ''}}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding-right:28px">
                                            <input type="text" name="method_curing"
                                                ...
                                                value="{{$permitdata->method_curing ?? ''}}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-md-12">
                            <div class="inputDiv">
                                ...
                                <textarea name="twc_control_pts" class="twcTextArea" rows="2"
                                    style="width:100%;">{{$permitdata->twc_control_pts ?? ''}}</textarea>
                            </div>
                            ...
                            <div class="inputDiv">
                                ...
                                <textarea name="back_propping" class="pt-2" rows="2"
                                    style="width:100%;">{{$permitdata->back_propping ?? ''}}</textarea>
                            </div>
                            <br>
                        ...
                        <div class="col-md-6 my-4" id="twc-email-box" class="twc-email-box">
                            <div class="inputDiv pc-twc mb-0 mt-6 d-flex" style="margin-top:10px !important;">
                                ...
                                <input type="email" class="form-control form-control-solid" name="pc_twc_email"
                                    id="pc-twc-email" placeholder="Email" value="{{$permitdata->pc_twc_email ?? ''}}"
                                    required="required">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="files_div">
                                ...
                                <input type="hidden" value="{{$permitLoadImage->id}}" name="unload_images[]"
                                    class="{{$permitLoadImage->id}}" />
                                @endforeach
                                @endif
                            </div>
                            <div id="new_div" class="m-md-2">
                                ...
                                <span id="{{$permitLoadImage->id}}">
                                    ...
                                    <button type="button" onclick="deleteImageFile({{$permitLoadImage->id}})"
                                        class="remove-file btn btn-danger btn-sm"
                                        data-filename="{{$permitLoadImage->id}}">&times;</button>
                                </span>
                                @endforeach
                                @endif
                            </div>
                        ...
                        <div class="col-md-6   mt-0" style="    min-height: 40px;margin-left:7px; ">
                            <div class="d-flex inputDiv">
                                ...
                                <textarea name="comments"
                                    class="form-control pt-2">{{$permitdata->comments ?? ''}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class=" justify-content-end"
                                    ...
                                    <label style="position: initial; flex-grow: 0; background: white">
                                        <input type="radio" class="btn-check" @if(isset($permitdata) &&
                                            $permitdata->principle_contractor==1){{'checked'}} @endif name="approval_PC"
                                        value="1" />
                                        <span
                                    ...
                                    <label style="position: initial; flex-grow: 0; background: white">
                                        <input type="radio" class="btn-check" checked name="approval_PC" value="2"
                                            @if(isset($permitdata) && $permitdata->principle_contractor==2){{'checked'}}
                                        @endif />
                                        <span
                    ...
                    <div class="row">
                        <div class="col-md-6" id="second_member" style="margin-top: 2rem;">
                            ...
                            <div class="d-flex inputDiv principleno">
                                ...
                                <div class="input">
                                    <input type="text" class="form-control" placeholder="Job title" id="job_title"
                                        name="job_title" value="{{$permitdata->job_title ?? ''}}">
                                </div>
                            </div>
                            ...
                            <div class="d-flex inputDiv d-block">
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="date" name="date1" style="background-color:#f5f8fa"
                                ...
                                <div class="d-flex flex-column" style="border: none">
                                    ...
                                    <div class="d-flex flex-row">
                                        <div style="display:flex; align-items: center; padding-left:10px">
                                            ...
                                            <span
                                                style="padding-left:14px;font-family: 'Inter', sans-serif; color:#000;font-size:14px;line-height: 2">Draw</span>
                                        </div>
                                        <div style="display:flex; align-items: center; padding-left:10px">
                                            ...
                                            <span
                                                style="padding-left:14px;font-family: 'Inter', sans-serif; color:#000;font-size:14px;line-height: 2">Name</span>
                                        </div>
                                        <!--end::Label-->
                                        <div style="display:flex; align-items: center; padding-left:10px">
                                            ...
                                            <span
                                                style="padding-left:14px;font-family: 'Inter', sans-serif; color:#000;font-size:14px;line-height: 2; min-width: fit-content; white-space: nowrap">PNG/JPG
                                                Upload </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                            <img style="background-color: #D3D3D3; border-radius: 15px; width: 300px;"
                                src="{{asset('temporary/signature/'.$permitdata->signature)}}" width="100%" />
                            @endif
                        </div>
                        <div class="col-md-6" id="first_member"
                            style="display: {{ (isset($permitdata->name1) && $permitdata->name1 != null) ? 'block' : 'none' }}; margin-top: 2rem;">
                            <div class="col" style="flex:100% !important;">
                                ...
                                <div class="d-flex inputDiv principleno">
                                    ...
                                    <input type="text" class="form-control" placeholder="Job title" id="job_title1"
                                        name="job_title1" value="{{$permitdata->job_title1 ?? ''}}">
                                ...
                                <div class="d-flex inputDiv d-block">
                                    ...
                                    <!--end::Label-->
                                    <div class="input">
                                        <input type="date" name="date2" style="background-color:#f5f8fa"
                                            value="{{ date('Y-m-d') }}" class="form-control form-control-solid">
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col">
                                    <div class="d-flex flex-column" style="border: none">
                                        ...
                                        <div class="d-flex flex-row">
                                            ...
                                            <div style="display:flex; align-items: center; padding-left:10px">
                                                <input type="radio" class="" id="flexCheckChecked1"
                                                    style="width: 12px;">
                                ...
                                @else
                                <img style="background-color: #D3D3D3; border-radius: 15px; width: 300px;"
                                    src="{{asset('temporary/signature/'.$permitdata->signature1)}}" width="100%" />
                                @endif
                                @endif
                            </div>
                        ...
                        <div class="col-md-6" id="third_member"
                            style="display: {{ (isset($permitdata->signatures[0]->name) && $permitdata->signatures[0]->name != null) ? 'block' : 'none' }}; margin-top: 2rem;">
                            <!-- <div class="d-flex inputDiv d-block">
                                        </div> -->
                            <div class="d-flex inputDiv principleno mt-0">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Name" id="name3"
                                    name="name3" value="{{$permitdata->signatures[0]->name ?? ''}}"
                                    style="color:#5e6278"
                                    {{ isset($permitdata->signatures[0]->name) && $permitdata->signatures[0]->name != null ? 'readonly' : '' }}>
                            </div>
                            <div class="d-flex inputDiv principleno">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="Job Title"
                                    id="job_title3" name="job_title3"
                                    value="{{$permitdata->signatures[0]->job_title ?? ''}}"
                                    {{ isset($permitdata->signatures[0]->job_title) && $permitdata->signatures[0]->job_title != null ? 'readonly' : '' }}>
                            </div>
                            <div class="d-flex inputDiv ">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="text" id="companyadmin3" class="form-control form-control-solid"
                                        placeholder="Company" name="company3"
                                        value="{{$permitdata->signatures[0]->company ?? ''}}"
                                        {{ isset($permitdata->signatures[0]->company) && $permitdata->signatures[0]->company != null ? 'readonly' : '' }}>
                                    <!-- name="company1" -->
                                    <input type="hidden" id="companyid3" class="form-control form-control-solid"
                                        placeholder="Company" name="companyid3" readonly="readonly">
                                </div>
                            </div>
                            <div class="d-flex inputDiv ">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="date" name="date3" style="background-color:#f5f8fa"
                                        value="{{$permitdata->signatures[0]->date ?? ''}}"
                                        class="form-control form-control-solid"
                                        {{ isset($permitdata->signatures[0]->date) && $permitdata->signatures[0]->date != null ? 'readonly' : '' }}>
                                    <!-- name="date1" -->
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="d-flex inputDiv" id="namesign3" style="display: none !important;">
                                    ...
                                    <input type="text" name="namesign3" id="namesign_id3"
                                        class="form-control form-control-solid">
                                </div>
                                <div class="d-flex inputDiv principleno m-0" id="sign3" style="border:none !important;">
                                    ...
                                    <span id="clear3" class="fa fa-undo cursor-pointer btn--clear"
                            ...
                            @else
                            <img style="background-color: #D3D3D3; border-radius: 15px; width: 300px;"
                                src="{{asset('temporary/signature/'.$permitdata->signatures[0]->signature)}}"
                                width="100%" />
                            @endif
                        </div>
                        <div class="col-md-6" id="fourth_member"
                            style="display: {{ isset($permitdata->signatures[1]->name) &&      $permitdata->signatures[1]->name != null ? 'block' : 'none' }}; margin-top: 2rem;">
                            <!-- <div class="d-flex inputDiv d-block">
                                        </div> -->
                            <div class="d-flex inputDiv principleno mt-0">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Name" id="name4"
                                    name="name4" style="color:#5e6278"
                                    value="{{$permitdata->signatures[1]->name ?? ''}}">
                            </div>
                            <div class="d-flex inputDiv principleno">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Job Title"
                                    id="job_title4" name="job_title4" value="{{$permitdata->job_title4 ?? ''}} ">
                            </div>
                            <div class="d-flex inputDiv ">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="text" id="companyadmin4" class="form-control form-control-solid"
                                        placeholder="Company" name="company4"
                                        value="{{$permitdata->signatures[1]->company ?? ''}}">
                                    <!-- name="company1" -->
                                    <input type="hidden" id="companyid4" class="form-control form-control-solid"
                            ...
                            <div class="d-flex inputDiv ">
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="date" name="date4" style="background-color:#f5f8fa"
                                        value="{{$permitdata->signatures[1]->date ?? ''}}"
                                        class="form-control form-control-solid">
                                    <!-- name="date1" -->
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="d-flex" id="namesign1" style="display: none !important;">
                                    ...
                                    <input type="text" name="namesign4" id="namesign_id4"
                                        class="form-control form-control-solid">
                                </div>
                                <div class="d-flex inputDiv principleno m-0" id="sign4" style="border:none !important;">
                                    ...
                                    <span id="clear4" class="fa fa-undo cursor-pointer btn--clear"
                                        style="line-height: 11; position:relative; top:51px; right:26px"></span>
                                </div>
                            ...
                            @else
                            <img style="background-color: #D3D3D3; border-radius: 15px; width: 300px;"
                                src="{{asset('temporary/signature/'.$permitdata->signatures[1]->signature)}}"
                                width="100%" />
                            @endif
                        </div>
                        <div class="col-md-6" id="fifth_member"
                            style="display: {{ isset($permitdata->signatures[2]->name) && $permitdata->signatures[2]->name != null ? 'block' : 'none' }}; margin-top: 2rem;">
                            <div class="d-flex inputDiv principleno mt-0">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                    <span class="required">Name:</span>
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Name" id="name5"
                                    name="name5" style="color:#5e6278"
                                    value="{{$permitdata->signatures[2]->name ?? ''}}">
                            </div>
                            <div class="d-flex inputDiv principleno">
                                <!--begin::Label-->
                                <label class="fs-6 fw-bold mb-2">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Job Title"
                                    id="job_title5" name="job_title5"
                                    value="{{$permitdata->signatures[2]->job_title ?? ''}}">
                            </div>
                            <div class="d-flex inputDiv ">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="text" id="companyadmin5" class="form-control form-control-solid"
                                        placeholder="Company" name="company5"
                                        value="{{$permitdata->signatures[2]->company5 ?? ''}}">
                                    <!-- name="company1" -->
                                    <input type="hidden" id="company5" class="form-control form-control-solid"
                                        placeholder="Company" name="company5" readonly="readonly">
                                </div>
                            </div>
                            <div class="d-flex inputDiv">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <div class="input">
                                    <input type="date" name="date5" style="background-color:#f5f8fa"
                                        value="{{$permitdata->signatures[2]->date ?? ''}}"
                                        class="form-control form-control-solid">
                                    <!-- name="date1" -->
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="d-flex align-items-center" id="namesign1" style="display: none !important;">
                                    ...
                                    <input type="text" name="namesign5" id="namesign_id5"
                                        class="form-control form-control-solid">
                                </div>
                                ...
                                <div class="d-flex inputDiv principleno m-0" id="sign5" style="border:none !important;">
                                    ...
                                    <span id="clear5" class="fa fa-undo cursor-pointer btn--clear"
                                        style="line-height: 11; position:relative; top:51px; right:26px"></span>
                                </div>
                                <div class="d-flex inputDiv principleno" id="sign4" style=" display: none !important">
                        ...
                        @else
                        <img style="background-color: #D3D3D3; border-radius: 15px; width: 300px;"
                            src="{{asset('temporary/signature/'.$permitdata->signatures[2]->signature)}}"
                            width="100%" />
                        @endif
                    </div>
                ...
                <div id="outerContainer">
                            ...
                            <div id="toolbarSidebarLeft">
                                <div id="sidebarViewButtons" class="splitToolbarButton toggled" role="radiogroup">
                                    ...
                                    <button id="viewOutline" class="toolbarButton"
                                        ...
                                        tabindex="3" data-l10n-id="document_outline" role="radio" aria-checked="false"
                                        aria-controls="outlineView">
                                        <span data-l10n-id="document_outline_label">Document Outline</span>
                                    </button>
                                    <button id="viewAttachments" class="toolbarButton" title="Show Attachments"
                                        tabindex="4" data-l10n-id="attachments" role="radio" aria-checked="false"
                                        aria-controls="attachmentsView">
                                        <span data-l10n-id="attachments_label">Attachments</span>
                                    </button>
                                    <button id="viewLayers" class="toolbarButton"
                                        title="Show Layers (double-click to reset all layers to the default state)"
                                        tabindex="5" data-l10n-id="layers" role="radio" aria-checked="false"
                    ...
                    <div id="mainContainer">
                            ...
                            <div class="editorParamsToolbarContainer">
                                ...
                                <div class="editorParamsSetter">
                                    ...
                                    <input type="range" id="editorFreeTextFontSize" class="editorParamsSlider"
                                        value="10" min="5" max="100" step="1" tabindex="101" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="editorParamsToolbarContainer">
                                ...
                                <div class="editorParamsSetter">
                                    ...
                                    <input type="range" id="editorInkThickness" class="editorParamsSlider" value="1"
                                        min="1" max="100" step="1" tabindex="102" />
                                </div>
                                <div class="editorParamsSetter">
                                    ...
                                    <input type="range" id="editorInkOpacity" class="editorParamsSlider" value="100"
                                        min="1" max="100" step="1" tabindex="103" />
                                </div>
                            </div>
                        </div>
                        <div class="editorParamsToolbar hidden doorHangerRight" id="editorInkParamsToolbar2">
                            <div class="editorParamsToolbarContainer">
                                <div class="editorParamsSetter">
                                    <label for="editorInk2Color" class="editorParamsLabel"
                                        data-l10n-id="editor_ink_color">Color</label>
                                    <input type="color" id="editorInk2Color" class="editorParamsColor" tabindex="104" />
                                </div>
                                <div class="editorParamsSetter">
                                    <label for="editorInk2Thickness" class="editorParamsLabel"
                                        data-l10n-id="editor_ink_thickness">Thickness</label>
                                    <input type="range" id="editorInk2Thickness" class="editorParamsSlider" value="1"
                                        min="1" max="500" step="15" tabindex="105" />
                                </div>
                            </div>
                        </div>
                        <div class="editorParamsToolbar hidden doorHangerRight" id="editorLineParamsToolbar">
                            <div class="editorParamsToolbarContainer">
                                <div class="editorParamsSetter">
                                    <label for="editorLineColor" class="editorParamsLabel"
                                        data-l10n-id="editor_line_color">Color</label>
                                    <input type="color" id="editorLineColor" class="editorParamsColor" tabindex="106" />
                                </div>
                                <div class="editorParamsSetter">
                                    <label for="editorLineThickness" class="editorParamsLabel"
                                        data-l10n-id="editor_Line_thickness">Thickness</label>
                                    <input type="range" id="editorLineThickness" class="editorParamsSlider" value="1"
                                        min="1" max="100" step="1" tabindex="107" />
                                </div>
                                <div class="editorParamsSetter">
                                    <label for="editorLineOpacity" class="editorParamsLabel"
                                        data-l10n-id="editor_Line_opacity">Opacity</label>
                                    <input type="range" id="editorLineOpacity" class="editorParamsSlider" value="100"
                                        min="1" max="100" step="1" tabindex="108" />
                                </div>
                            </div>
                        </div>
                        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                            <div id="secondaryToolbarButtonContainer">
                                ...
                                <button id="secondaryDownload" class="secondaryToolbarButton visibleMediumView"
                                    title="Save" tabindex="53" data-l10n-id="save">
                                ...
                                <button id="presentationMode" class="secondaryToolbarButton"
                                    title="Switch to Presentation Mode" tabindex="54" data-l10n-id="presentation_mode">
                                ...
                                <div id="toolbarViewer">
                                    <div id="toolbarViewerLeft">
                                        <button id="sidebarToggle" class="toolbarButton" title="Toggle Sidebar"
                                            tabindex="11" data-l10n-id="toggle_sidebar" aria-expanded="false"
                                            aria-controls="sidebarContainer">
                                            <span data-l10n-id="toggle_sidebar_label">Toggle Sidebar</span>
                                        </button>
                                        <div class="toolbarButtonSpacer"></div>
                                        <button id="viewFind" class="toolbarButton" title="Find in Document"
                                            tabindex="12" data-l10n-id="findbar" aria-expanded="false"
                                    ...
                                    <div id="toolbarViewerRight">
                                        ...
                                        <div id="editorModeButtons" class="splitToolbarButton toggled"
                                            ...
                                            <button id="editorFreeText" class="toolbarButton" disabled="disabled"
                                                title="Text" role="radio" aria-checked="false"
                                                aria-controls="editorFreeTextParamsToolbar" tabindex="35"
                                                data-l10n-id="editor_free_text2">
                                                <span data-l10n-id="editor_free_text2_label">Text</span>
                                            </button>
                                            <button id="editorInk" class="toolbarButton" disabled="disabled"
                                                title="Draw" role="radio" aria-checked="false"
                                                aria-controls="editorInkParamsToolbar" tabindex="36"
                                                data-l10n-id="editor_ink2">
                                                <span data-l10n-id="editor_ink2_label">Draw</span>
                                            </button>
                                            <button id="editorInk2" class="toolbarButton" disabled="disabled"
                                                title="Highlight" role="radio" aria-checked="false"
                                                aria-controls="editorInkParamsToolbar2" tabindex="37"
                                                data-l10n-id="editor_ink22">
                                                <span data-l10n-id="editor_ink2_label">Draw</span>
                                            </button>
                                            <button id="editorLine" class="toolbarButton" disabled="disabled"
                                                title="Line" role="radio" aria-checked="false"
                                                aria-controls="editorLineParamsToolbar" tabindex="38"
                                                data-l10n-id="editor_Line2">
                                                <span data-l10n-id="editor_ink2_label">Draw</span>
                                            </button>
                                        </div>
                                        ...
                                        <button id="secondaryToolbarToggle" class="toolbarButton" title="Tools"
                                            tabindex="48" data-l10n-id="tools" aria-expanded="false"
                    ...
                    <div id="dialogContainer">
                        <dialog id="passwordDialog">
                            <div class="row">
                                <label for="password" id="passwordText" data-l10n-id="password_label">Enter the password
                        ...
                        <dialog id="documentPropertiesDialog">
                            ...
                            <div class="row">
                                <span id="pageCountLabel" data-l10n-id="document_properties_page_count">Page
                                    Count:</span>
                            ...
                            <div class="separator"></div>
                            <div class="row">
                                <span id="linearizedLabel" data-l10n-id="document_properties_linearized">Fast Web
                                    View:</span>
...
if (signaturePad) {
    signaturePad.addEventListener('endStroke', function() {
        ...
        if (pc_approval == 2) {
            console.log("here");
            if (signaturePad.toDataURL('image/png') !=
                ...
                $("#submitbutton").removeClass("btn-primary").addClass(
            ...
            if (signtype1 == 1) {
                if (signaturePad.toDataURL('image/png') !=
                    ...
                    $("#submitbutton").removeClass("btn-secondary").addClass("btn-primary").removeAttr(
                        "disabled");
                } else {
                    $('#submitbutton').prop('disabled', true);
                    $("#submitbutton").removeClass("btn-primary").addClass(
...
if (signaturePad1) {
    signaturePad1.addEventListener('endStroke', function() {
        ...
        if (signtype == 1 || pdfsign == 1) {
            console.log("here");
            if (signaturePad1.toDataURL('image/png') !=
                "data:image/png;base64,"
            ) {
...
clearBtns.forEach(clearbtn => {
    clearbtn.addEventListener('click', function(e) {
        ...
        if (e.target.getAttribute('id') === 'clear') {
            ...
            signaturePad.clear();
            $("#signature").val('');
            $("#submitbutton").removeClass("btn-primary").addClass("btn-secondary").prop("disabled",
                true);
            $("#sigimage").text("Signature Not Added").removeClass('text-success').addClass(
                'text-danger');
        }
