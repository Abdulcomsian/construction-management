                ...
                <form id="scaffolding" action="{{route('scaffolding.store')}}" method="post"
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex inputDiv d-block">
                                    <div class="d-flex modalDiv d-block">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                            placeholder="TWS Name" name="tws_name"
                                            value="{{$scaffolddata->tws_name ?? ''}}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 mt-20">
                                <div class="d-flex inputDiv" style=" height: 87px;">
                                    ...
                                    <div style="margin-left: 10px; text-align:center;">
                                        ...
                                        <textarea name="equipment_materials_desc" rows="2"
                                            cols="50">{{$scaffolddata->equipment_materials_desc ?? ''}}</textarea>
                                    </div>
                                </div>
                                <div class="d-flex inputDiv">
                                    ...
                                    <!--end::Radio group-->
                                    <div style="margin-left: 10px; text-align:center;">
                                        <textarea name="workmanship_desc" rows="2"
                                            cols="50">{{$scaffolddata->workmanship_desc ?? ''}}</textarea>
                                    </div>
                                ...
                                <div class="d-flex inputDiv">
                                    ...
                                    <div style="margin-left: 10px; text-align:center;">
                                        ...
                                        <textarea name="drawings_design_desc" rows="2"
                                            cols="50">{{$scaffolddata->drawings_design_desc ?? ''}}</textarea>
                                ...
                                <div class="d-flex inputDiv">
                                    ...
                                    <!--end::Radio group-->
                                    <div style="margin-left: 10px; text-align:center;">
                                        <textarea name="loading_limit_desc" rows="2"
                                            cols="50">{{$scaffolddata->loading_limit_desc ?? ''}}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="d-flex inputDiv">
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2"
                                    style="background:green;color:#fff;padding:10px;width: 20%;">
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['even_stable_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['base_Plates_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['sole_boards_radio'] == 2 ? '' : 'd-none'}}"
                                        name="sole_boards_comment" rows="2"
                                        cols="90">{{$checkAndComments->comments['sole_boards_comment'] ?? ''}}</textarea>
                                </div>
                            </div>
                            <div class="d-flex inputDiv">
                                <!--begin::Label-->
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['undermined_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2"
                                    style="width: 20%;background:green;color:#fff;padding:10px;">
                                    Standards:
                                </label>
                            </div>
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['Plumb_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="staggered_joints_radio" value="1"
                                            {{$checkAndComments->radio_checks['staggered_joints_radio'] == 1 ? 'checked'
                                        : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="staggered_joints_radio" value="2"
                                            {{$checkAndComments->radio_checks['staggered_joints_radio'] == 2 ? 'checked'
                                        : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="staggered_joints_radio" value="3"
                                            {{$checkAndComments->radio_checks['staggered_joints_radio'] == 3 ? 'checked'
                                        : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['staggered_joints_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="wrong_spacing_radio" value="1"
                                            {{$checkAndComments->radio_checks['wrong_spacing_radio'] == 1 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="wrong_spacing_radio" value="2"
                                            {{$checkAndComments->radio_checks['wrong_spacing_radio'] == 2 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="wrong_spacing_radio" value="3"
                                            {{$checkAndComments->radio_checks['wrong_spacing_radio'] == 3 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['wrong_spacing_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['damaged_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['trap_boards_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="incomplete_boarding_radio" value="1"
                                            {{$checkAndComments->radio_checks['incomplete_boarding_radio'] == 1 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="incomplete_boarding_radio" value="2"
                                            {{$checkAndComments->radio_checks['incomplete_boarding_radio'] == 2 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="incomplete_boarding_radio" value="3"
                                            {{$checkAndComments->radio_checks['incomplete_boarding_radio'] == 3 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['incomplete_boarding_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="supports_ties_radio" value="1"
                                            {{$checkAndComments->radio_checks['supports_ties_radio'] == 1 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="supports_ties_radio" value="2"
                                            {{$checkAndComments->radio_checks['supports_ties_radio'] == 2 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="supports_ties_radio" value="3"
                                            {{$checkAndComments->radio_checks['supports_ties_radio'] == 3 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['supports_ties_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="insufficient_length_radio" value="1"
                                            {{$checkAndComments->radio_checks['insufficient_length_radio'] == 1 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="insufficient_length_radio" value="2"
                                            {{$checkAndComments->radio_checks['insufficient_length_radio'] == 2 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="insufficient_length_radio" value="3"
                                            {{$checkAndComments->radio_checks['insufficient_length_radio'] == 3 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['insufficient_length_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="missing_loose_radio" value="1"
                                            {{$checkAndComments->radio_checks['missing_loose_radio'] == 1 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="missing_loose_radio" value="2"
                                            {{$checkAndComments->radio_checks['missing_loose_radio'] == 2 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="missing_loose_radio" value="3"
                                            {{$checkAndComments->radio_checks['missing_loose_radio'] == 3 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['missing_loose_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="wrong_fittings_radio" value="1"
                                            {{$checkAndComments->radio_checks['wrong_fittings_radio'] == 1 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="wrong_fittings_radio" value="2"
                                            {{$checkAndComments->radio_checks['wrong_fittings_radio'] == 2 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="wrong_fittings_radio" value="3"
                                            {{$checkAndComments->radio_checks['wrong_fittings_radio'] == 3 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['wrong_fittings_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['not_level_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="joined_same_bays_radio" value="1"
                                            {{$checkAndComments->radio_checks['joined_same_bays_radio'] == 1 ? 'checked'
                                        : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="joined_same_bays_radio" value="2"
                                            {{$checkAndComments->radio_checks['joined_same_bays_radio'] == 2 ? 'checked'
                                        : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="joined_same_bays_radio" value="3"
                                            {{$checkAndComments->radio_checks['joined_same_bays_radio'] == 3 ? 'checked'
                                        : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['joined_same_bays_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    <label>
                                        <input type="radio" class="btn-check" name="loose_damaged_radio" value="1"
                                            {{$checkAndComments->radio_checks['loose_damaged_radio'] == 1 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="loose_damaged_radio" value="2"
                                            {{$checkAndComments->radio_checks['loose_damaged_radio'] == 2 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="loose_damaged_radio" value="3"
                                            {{$checkAndComments->radio_checks['loose_damaged_radio'] == 3 ? 'checked' :
                                        ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['loose_damaged_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['wrong_height_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['some_missing_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['GuardRails_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_wrongfitting_radio"
                                            value="1" {{$checkAndComments->radio_checks['coupling_wrongfitting_radio']
                                        == 1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_wrongfitting_radio"
                                            value="2" {{$checkAndComments->radio_checks['coupling_wrongfitting_radio']
                                        == 2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_wrongfitting_radio"
                                            value="3" {{$checkAndComments->radio_checks['coupling_wrongfitting_radio']
                                        == 3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['coupling_wrongfitting_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_somemissing_radio"
                                            value="1" {{$checkAndComments->radio_checks['coupling_somemissing_radio'] ==
                                        1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_somemissing_radio"
                                            value="2" {{$checkAndComments->radio_checks['coupling_somemissing_radio'] ==
                                        2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_somemissing_radio"
                                            value="3" {{$checkAndComments->radio_checks['coupling_somemissing_radio'] ==
                                        3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['coupling_somemissing_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_loosedamaged_radio"
                                            value="1" {{$checkAndComments->radio_checks['coupling_loosedamaged_radio']
                                        == 1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_loosedamaged_radio"
                                            value="2" {{$checkAndComments->radio_checks['coupling_loosedamaged_radio']
                                        == 2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="coupling_loosedamaged_radio"
                                            value="3" {{$checkAndComments->radio_checks['coupling_loosedamaged_radio']
                                        == 3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['coupling_loosedamaged_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_wrongfitting_radio"
                                            value="1" {{$checkAndComments->radio_checks['bracing_wrongfitting_radio'] ==
                                        1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_wrongfitting_radio"
                                            value="2" {{$checkAndComments->radio_checks['bracing_wrongfitting_radio'] ==
                                        2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_wrongfitting_radio"
                                            value="3" {{$checkAndComments->radio_checks['bracing_wrongfitting_radio'] ==
                                        3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['bracing_wrongfitting_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_somemissing_radio" value="1"
                                            {{$checkAndComments->radio_checks['bracing_somemissing_radio'] == 1 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_somemissing_radio" value="2"
                                            {{$checkAndComments->radio_checks['bracing_somemissing_radio'] == 2 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_somemissing_radio" value="3"
                                            {{$checkAndComments->radio_checks['bracing_somemissing_radio'] == 3 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['bracing_somemissing_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_loosedamaged_radio"
                                            value="1" {{$checkAndComments->radio_checks['bracing_loosedamaged_radio'] ==
                                        1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_loosedamaged_radio"
                                            value="2" {{$checkAndComments->radio_checks['bracing_loosedamaged_radio'] ==
                                        2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="bracing_loosedamaged_radio"
                                            value="3" {{$checkAndComments->radio_checks['bracing_loosedamaged_radio'] ==
                                        3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['bracing_loosedamaged_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="partially_removed_radio" value="1"
                                            {{$checkAndComments->radio_checks['partially_removed_radio'] == 1 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="partially_removed_radio" value="2"
                                            {{$checkAndComments->radio_checks['partially_removed_radio'] == 2 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="partially_removed_radio" value="3"
                                            {{$checkAndComments->radio_checks['partially_removed_radio'] == 3 ?
                                        'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['partially_removed_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="debrings_somemissing_radio"
                                            value="1" {{$checkAndComments->radio_checks['debrings_somemissing_radio'] ==
                                        1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="debrings_somemissing_radio"
                                            value="2" {{$checkAndComments->radio_checks['debrings_somemissing_radio'] ==
                                        2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="debrings_somemissing_radio"
                                            value="3" {{$checkAndComments->radio_checks['debrings_somemissing_radio'] ==
                                        3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['debrings_somemissing_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div class="nav-group nav-group-fluid">
                                    <label>
                                        <input type="radio" class="btn-check" name="loose_damaged_broken_radio"
                                            value="1" {{$checkAndComments->radio_checks['loose_damaged_broken_radio'] ==
                                        1 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Pass</span>
                                    </label>
                                    ...
                                    <label>
                                        <input type="radio" class="btn-check" name="loose_damaged_broken_radio"
                                            value="2" {{$checkAndComments->radio_checks['loose_damaged_broken_radio'] ==
                                        2 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary2 px-4">Fail</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="btn-check" name="loose_damaged_broken_radio"
                                            value="3" {{$checkAndComments->radio_checks['loose_damaged_broken_radio'] ==
                                        3 ? 'checked' : ''}} />
                                        <span
                                            class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N/A</span>
                                    </label>
                                ...
                                <div style="margin-left: 10px; text-align:center;">
                                    ...
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['loose_damaged_broken_radio'] == 2 ? '' : 'd-none'}}"
                            ...
                            <div class="d-flex inputDiv">
                                ...
                                <div style="margin-left: 70px; ">
                                    <textarea
                                        class="{{$checkAndComments->radio_checks['other_radio'] == 1 ? '' : 'd-none'}}"
                                    ...
                                    <div class="d-flex inputDiv d-block">
                                        <div class="d-flex modalDiv d-block">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                ...
                                                value="{{\Auth::user()->job_title ?? ''}}" required>
                                    ...
                                    <div class="d-flex inputDiv d-block">
                                        <div class="d-flex modalDiv d-block">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                ...
                                                value="{{$project->company->name ?? ''}}" required>
                                            ...
                                            <div class="nav-group nav-group-fluid ">
                                                ...
                                                <label>
                                                    <input type="radio" class="btn-check" name="Scaff_tag_signed"
                                                        value="1" {{$scaffolddata->Scaff_tag_signed == 1 ? 'checked' :
                                                    ''}} />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Y</span>
                                                </label>
                                                ...
                                                <label>
                                                    <input type="radio" class="btn-check" name="Scaff_tag_signed"
                                                        value="2" {{$scaffolddata->Scaff_tag_signed == 2 ? 'checked' :
                                                    ''}} />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N</span>
                                                </label>
                                            ...
                                            <div class="nav-group nav-group-fluid ">
                                                ...
                                                <label>
                                                    <input type="radio" class="btn-check" name="carry_out_inspection"
                                                        value="1" {{$scaffolddata->carry_out_inspection == 1 ? 'checked'
                                                    : ''}} />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Y</span>
                                                </label>
                                                ...
                                                <label>
                                                    <input type="radio" class="btn-check" name="carry_out_inspection"
                                                        value="2" {{$scaffolddata->carry_out_inspection == 2 ? 'checked'
                                                    : ''}} />
                                                    <span
                                                        class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">N</span>
                                                </label>
