            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <!--end::Search-->
                        <div class="">
                            <a href="{{url('addUser')}}" class="addBtn btn btn-primary er fs-6 px-8 py-4">
                                Add User
                            </a>
                        </div>
                    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{ route('users.edit',$user->id) }}">
                                            <div class="symbol-label">
                                                <img src="{{$user->image ? $user->image : 'assets/media/avatars/blank.png' }}"
                                ...
                                <td>
                                    <div
                                        class="badge badge-{{$user->status == \App\HelperFunction\Status::Active ? 'success' : 'danger' }}">
                                        {{$user->status}}</div>
                                </td>
                                <!--end::User=-->
                                <!--begin::Joined-->
                                ...
                                <td class="d-flex">
                                    ...
                                    <form method="POST" action="{{ route('users.destroy',$user->id) }}"
                                        ...
                                        <button id="{{$user->id}}" type="submit"
                                            class="confirm btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
