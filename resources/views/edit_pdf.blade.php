...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link
      ...
      href="https://mozilla.github.io/pdf.js/web/locale/locale.properties"
    />
    ...
    <script
      defer
      src="https://cdn.jsdelivr.net/npm/es-module-shims@1.4.7/dist/es-module-shims.js"
    ></script>
    ...
    <script src="{{ asset('pdf-editor/src/genericcom.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_attachment_viewer.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_cursor_tools.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_document_properties.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_find_bar.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_layer_viewer.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_outline_viewer.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_presentation_mode.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_sidebar.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_thumbnail_viewer.js') }}"></script>
    <script src="{{ asset('pdf-editor/src/pdf_print_service.js') }}"></script>
                    ...
                    <div id="toolbarViewer">
                      ...
                      <div id="toolbarViewerRight">
                        ...
                        >
                          ...
                          >
                            <span data-l10n-id="editor_free_text2_label"
                              >Text</span
                            >
                          </button>
                          <button
