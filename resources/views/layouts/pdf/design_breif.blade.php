...
<page pageset="old">
    <div style="padding: 10px; width: 100%; max-width: 70%; margin: auto;">
            ...
            <table>
                <tbody>
                    <tr style="min-height: 150px;">
                        ...
                        <td style="width: 250px; font-size:12px;">{{$data['projname']}}</td>
                        <td style="width: 200px;background:gray;color:white">
                    ...
                    <tr style="height: 150px;">
                        <td style="width: 200px;background:gray;color:white">
                            <label for="" style="float: left;width: 200px; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b style="font-size: 12px;">Designer Company Name</b></label>
                        </td>
                        <td style="max-height:70px !important; font-size:12px;"> {{$data['designer_company_name']}}</td>
                        <td style="width: 200px;background:gray;color:white">
                            <label for="" style="float: left;width: 200px; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b style="font-size: 12px;">Designer Company Email Address</b></label>
                        </td>
        ...
        <div class="tableDiv paddingTable" style="margin: 20px 0px;">
            <table>
                <tbody>
                    <tr>
                        <td style="width: 200px;background:gray;color:white">
                            <label for="" style="float: left;width: 200px; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b style="font-size: 12px;">Temporary Works Category</b></label>
                        </td>
                        <td style="font-size:12px;"> {{$data['tw_category']}}</td>
                        <td style="width: 200px;background:gray;color:white">
                            <label for="" style="float: left;width: 200px; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b style="font-size: 12px;">Temporary Works Risk Class</b></label>
                        </td>
                        <td style="font-size:12px;"> {{$data['tw_risk_class']}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="tableDiv paddingTable" style="margin: 20px 0px;">
            <table>
                <tbody>
                    <tr>
                        <td style="width: 200px;background:gray;color:white">
                            <label for="" style="float: left;width: 200px; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b style="font-size: 12px;">Design requirement for</b></label>
                        </td>
                        <td style="width: 300px; font-size:12px;">{{$data['design_requirement_text']}}</td>
                        <td style="width: 200px;background:gray;color:white">
                            <label for="" style="float: left;width: 200px; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b style="font-size: 12px;">Description of Temporary Works required</b></label>
                        </td>
        ...
        <div class="tableDiv paddingTable" style="margin: 20px 0px;">
            <table>
                <thead style="background:gray;color:white">
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Scope of Design Output and date required from the Temporary
                        work Engineer</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Date</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Scope of Design Output and date required from the Temporary
                        work Engineer</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Date</th>
                </thead>
        ...
        <div class="tableDiv paddingTable" style="margin: 20px 0px;">
            <table>
                <thead style="background:gray;color:white">
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Scope of Design Output Required from TEMPORARY WORKS
                        DESIGNER</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Y</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">N</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Date Required</th>
                </thead>
                <tbody>
                    <tr>
        ...
        <div class="tableDiv paddingTable" style="margin: 20px 0px;">
            <table>
                <thead style="">
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">List of attachments</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">Y</th>
                    <th style="color: #fff; background: gray !important; padding: 10px; font-size:12px;">N</th>
                </thead>
                <tbody>
        ...
        <div class="tableDiv paddingTable" style="margin: 20px 0px;">
            ...
            font-weight: 700;">
                        <strong style="font-size:12px;">Attachments / Spec / Existing Designs and Existing Site Conditions (folders to upload) </strong>
