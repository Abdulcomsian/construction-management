            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>@if($scopdesg['preliminary_sketches_date']){{ date('d-m-Y',strtotime($scopdesg['preliminary_sketches_date']))}}@endif</td>
                    </tr>
                    <tr>
                        ...
                        <td>@if($scopdesg['construction_rawings_date']){{ date('d-m-Y',strtotime($scopdesg['construction_rawings_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['design_calculations_date']){{ date('d-m-Y',strtotime($scopdesg['design_calculations_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['design_check_certificate_date']){{ date('d-m-Y',strtotime($scopdesg['design_check_certificate_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['loading_criteria_date']){{ date('d-m-Y',strtotime($scopdesg['loading_criteria_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['construction_erection_sequence_information_date']){{ date('d-m-Y',strtotime($scopdesg['construction_erection_sequence_information_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['inspection_checklist_date']){{ date('d-m-Y',strtotime($scopdesg['inspection_checklist_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['monitoring_requirements_date']){{ date('d-m-Y',strtotime($scopdesg['monitoring_requirements_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['specifications_date']){{ date('d-m-Y',strtotime($scopdesg['specifications_date']))}}@endif</td>
                    ...
                    <tr>
                        ...
                        <td>@if($scopdesg['design_inspection_test_plans_date']){{ date('d-m-Y',strtotime($scopdesg['design_inspection_test_plans_date']))}}@endif</td>
