                            ...
                            <table>
                                <tbody>
                                    <tr style="min-height: 150px;">
                                        ...
                                        <td style="width: 200px; font-size:12px;">{{$user->userDiCompany->name}}</td>
                                ...
                                <tbody>
                                    ...
                                    <tr style="min-height: 150px;">
                                        <td style="width: 250px;font-size:10px">
                                            <p>You have been appointed as the <b>Temporary Works Designer</b> for the above Project.
                                            This appointment satisfies the recommendation in BS 5975: 2019 to appoint a Temporary Works Designer.
                                            The duties and competencies are summarised below and are detailed in the {{$user->userDiCompany->name}} Temporary Works Procedure</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <ul style="text-align: center;">
                                                    <li>
                                                        The TWC has overall responsibility to ensure that all temporary works under their control are undertaken in
                                                         accordance with the {{$user->userDiCompany->name}} Temporary WorksProcedure.
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr style="min-height: 150px;">
                                        ...
                                        <td style="width:500px; font-size:12px;">{{date('d-m-Y',strtotime($data['date']))}}</td>
                                    </tr>
                                    <tr style="min-height: 150px;">
                                        <td style="width:120px;background:#c9cacc;color:#000000e3">
