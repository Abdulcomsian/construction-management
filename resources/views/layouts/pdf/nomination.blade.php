...
<page pageset="old">
    <div style="padding: 10px; width: 100%; margin: auto;">
        <div class="topDiv" style="display: flex; justify-content: space-between;">
            ...
            <p style="font-size:12px;width:100%">Provide supporting evidence to {{$user->userCompany->name}} of the
                competence, qualifications, training and experience of the individuals nominated to work as
                {{$data['nominated_role']}}. This form will enable {{$user->userCompany->name}} to assess the competence
                of the individual to undertake the appropriate role.</p>
        </div>
    </div>
            ...
            <tbody>
                <tr style="min-height: 150px;">
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;">
                ...
                <tr style="min-height: 150px;">
                    ...
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$project_no ?? ''}}</td>
                </tr>
                <tr style="height: 150px;">
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Project Manager</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['project_manager'] ?? ''}}</td>
                </tr>
                <tr>
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Nominated person</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['nominated_person'] ?? ''}}</td>
                </tr>
                ...
                <tr style="height: 150px;">
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Nominated person’s employer</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['nominated_person_employer'] ?? ''}}
                    </td>
                </tr>
                <tr style="height: 150px;">
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Nominated role</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['nominated_role'] ?? ''}}</td>
                </tr>
                <tr style="height: 150px;">
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Description of role being proposed:
                                (Include details of the type of temporary works that the individual will be
                                managing)</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['description_of_role'] ?? ''}}</td>
                </tr>
                <tr>
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="font-weight:900;float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Description of the limits of authority of the individual (if
                                applicable)</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['Description_limits_authority'] ??
                        ''}}</td>
                </tr>
                <tr>
                    <td style="width: 400px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size:12px;">Does the individual have authority to issue permits to load /
                                take into use and or permit to dismantle?</b></label>
                    </td>
    ...
    <div class="tableDiv paddingTable" style="margin: 10px 0px;">
        ...
        <table>
            <thead>
                <tr>
                    <td style="color: #fff; background: gray !important; padding: 10px; font-size:10px;">Project title
                    </td>
                    <td style="color: #fff; background: gray !important; padding: 10px; font-size:10px;">Role</td>
                    <td style="color: #fff; background: gray !important; padding: 10px; font-size:10px;">Description of
                        involvement</td>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="tableDiv paddingTable" style="margin: 5px 0px;">
        <div style="background:gray; padding: 12px; margin-top: 20px; color: white;">
            ...
            <p style="margin: 0;font-size:10px;">Indicate level of experience gained on the various types of temporary
                works, using key below and ticking the relevant boxes in the table on the subsequent page
            </p>
        </div>
        <table>
            <thead style="display: none">
                <tr>
                    <td style="color: #fff; background: gray !important; padding: 10px; font-size:10px;"></td>
                    <td style="color: #fff; background: gray !important; padding: 10px; font-size:10px;"></td>
                    <td style="color: #fff; background: gray !important; padding: 10px; font-size:10px;"></td>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">
                        Worked with this type of temporary works, but with no direct involvement but has a basic
        ...
        <table class="table tableBordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['Temporary_offices']=="N" ? $data['Temporary_offices'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Temporary_offices']=="A" ? $data['Temporary_offices'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Temporary_offices']=="K" ? $data['Temporary_offices'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Temporary_offices']=="E" ? $data['Temporary_offices'] : ''}}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['Welfare_facilities']=="N" ? $data['Welfare_facilities'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Welfare_facilities']=="A" ? $data['Welfare_facilities'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Welfare_facilities']=="K" ? $data['Welfare_facilities'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Welfare_facilities']=="E" ? $data['Welfare_facilities'] : ''}}
                    </td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Precast facilities</td>
                    <td style="font-size:10px;">{{$data['Precast_facilities']=="N" ? $data['Precast_facilities'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Precast_facilities']=="A" ? $data['Precast_facilities'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Precast_facilities']=="K" ? $data['Precast_facilities'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Precast_facilities']=="E" ? $data['Precast_facilities'] : ''}}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['System_scaffolding']=="N" ? $data['System_scaffolding'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['System_scaffolding']=="A" ? $data['System_scaffolding'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['System_scaffolding']=="K" ? $data['System_scaffolding'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['System_scaffolding']=="E" ? $data['System_scaffolding'] : ''}}
                    </td>
                </tr>
                <tr>
                    <td style="font-size:10px;">System staircases</td>
                    <td style="font-size:10px;">{{$data['System_staircases']=="N" ? $data['System_staircases'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['System_staircases']=="A" ? $data['System_staircases'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['System_staircases']=="K" ? $data['System_staircases'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['System_staircases']=="E" ? $data['System_staircases'] : ''}}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['Suspension_systems']=="N" ? $data['Suspension_systems'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Suspension_systems']=="A" ? $data['Suspension_systems'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Suspension_systems']=="K" ? $data['Suspension_systems'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Suspension_systems']=="E" ? $data['Suspension_systems'] : ''}}
                    </td>
                </tr>
                <!-- 3 -->
                <tr>
                    <td style="font-size:10px;" rowspan="4">Formwork/ falsework</td>
                ...
                <!-- 4 -->
                <tr>
                    <td style="font-size:10px;" rowspan="6">Construction plant</td>
                    <td style="font-size:10px;">Crane supports & foundations</td>
                    <td style="font-size:10px;">{{$data['Crane_supports_foundations']=="N" ?
                        $data['Crane_supports_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Crane_supports_foundations']=="A" ?
                        $data['Crane_supports_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Crane_supports_foundations']=="K" ?
                        $data['Crane_supports_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Crane_supports_foundations']=="E" ?
                        $data['Crane_supports_foundations'] : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Hoist ties & foundations</td>
                    <td style="font-size:10px;">{{$data['Hoist_ties_foundations']=="N" ? $data['Hoist_ties_foundations']
                        : ''}}</td>
                    <td style="font-size:10px;">{{$data['Hoist_ties_foundations']=="A" ? $data['Hoist_ties_foundations']
                        : ''}}</td>
                    <td style="font-size:10px;">{{$data['Hoist_ties_foundations']=="K" ? $data['Hoist_ties_foundations']
                        : ''}}</td>
                    <td style="font-size:10px;">{{$data['Hoist_ties_foundations']=="E" ? $data['Hoist_ties_foundations']
                        : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Mast climbers & foundations</td>
                    <td style="font-size:10px;">{{$data['Mast_climbers_foundations']=="N" ?
                        $data['Mast_climbers_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Mast_climbers_foundations']=="A" ?
                        $data['Mast_climbers_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Mast_climbers_foundations']=="K" ?
                        $data['Mast_climbers_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Mast_climbers_foundations']=="E" ?
                        $data['Mast_climbers_foundations'] : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Mobile crane foundations</td>
                    <td style="font-size:10px;">{{$data['Mobile_crane_foundations']=="N" ?
                        $data['Mobile_crane_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Mobile_crane_foundations']=="A" ?
                        $data['Mobile_crane_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Mobile_crane_foundations']=="K" ?
                        $data['Mobile_crane_foundations'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Mobile_crane_foundations']=="E" ?
                        $data['Mobile_crane_foundations'] : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Piling mats & working platforms</td>
                    <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="N" ?
                        $data['Piling_mats_working_platforms'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="A" ?
                        $data['Piling_mats_working_platforms'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="K" ?
                        $data['Piling_mats_working_platforms'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="E" ?
                        $data['Piling_mats_working_platforms'] : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Lifting/ handling devices</td>
                    <td style="font-size:10px;">{{$data['Lifting_handling_devices']=="N" ?
                        $data['Lifting_handling_devices'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Lifting_handling_devices']=="A" ?
                        $data['Lifting_handling_devices'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Lifting_handling_devices']=="K" ?
                        $data['Lifting_handling_devices'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Lifting_handling_devices']=="E" ?
                        $data['Lifting_handling_devices'] : ''}}</td>
                </tr>
                <!-- 5 -->
                <tr>
                    <td style="font-size:10px;" rowspan="6">Excavation/ earthworks</td>
                    <td style="font-size:10px;">Excavation support</td>
                    <td style="font-size:10px;">{{$data['Excavation_support']=="N" ? $data['Excavation_support'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Excavation_support']=="A" ? $data['Excavation_support'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Excavation_support']=="K" ? $data['Excavation_support'] : ''}}
                    </td>
                    <td style="font-size:10px;">{{$data['Excavation_support']=="E" ? $data['Excavation_support'] : ''}}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['Ground_anchor_soil_nailing']=="N" ?
                        $data['Ground_anchor_soil_nailing'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Ground_anchor_soil_nailing']=="A" ?
                        $data['Ground_anchor_soil_nailing'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Ground_anchor_soil_nailing']=="K" ?
                        $data['Ground_anchor_soil_nailing'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Ground_anchor_soil_nailing']=="E" ?
                        $data['Ground_anchor_soil_nailing'] : ''}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['Existing_structures_during_construction']=="N" ?
                        $data['Existing_structures_during_construction'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Existing_structures_during_construction']=="A" ?
                        $data['Existing_structures_during_construction'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Existing_structures_during_construction']=="K" ?
                        $data['Existing_structures_during_construction'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Existing_structures_during_construction']=="E" ?
                        $data['Existing_structures_during_construction'] : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">New structures during construction</td>
                    <td style="font-size:10px;">{{$data['New_structures_during_construction']=="N" ?
                        $data['New_structures_during_construction'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['New_structures_during_construction']=="A" ?
                        $data['New_structures_during_construction'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['New_structures_during_construction']=="K" ?
                        $data['New_structures_during_construction'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['New_structures_during_construction']=="E" ?
                        $data['New_structures_during_construction'] : ''}}</td>
                </tr>
                <tr>
                    <td style="font-size:10px;">Structural steelwork erection</td>
                    <td style="font-size:10px;">{{$data['Structural_steelwork_erection']=="N" ?
                        $data['Structural_steelwork_erection'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Structural_steelwork_erection']=="A" ?
                        $data['Structural_steelwork_erection'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Structural_steelwork_erection']=="K" ?
                        $data['Structural_steelwork_erection'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Structural_steelwork_erection']=="E" ?
                        $data['Structural_steelwork_erection'] : ''}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;">{{$data['Temporary_underpinning']=="N" ? $data['Temporary_underpinning']
                        : ''}}</td>
                    <td style="font-size:10px;">{{$data['Temporary_underpinning']=="A" ? $data['Temporary_underpinning']
                        : ''}}</td>
                    <td style="font-size:10px;">{{$data['Temporary_underpinning']=="K" ? $data['Temporary_underpinning']
                        : ''}}</td>
                    <td style="font-size:10px;">{{$data['Temporary_underpinning']=="E" ? $data['Temporary_underpinning']
                        : ''}}</td>
                </tr>
                <tr>
                ...
                <!--  -->
                <tr>
                    <td rowspan="2" style="font-size:10px;">Permanent works</td>
                    <td style="font-size:10px;">Partial permanent support conditions</td>
                    <td style="font-size:10px;">{{$data['Partial_permanent_support_conditions']=="N" ?
                        $data['Partial_permanent_support_conditions'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Partial_permanent_support_conditions']=="A" ?
                        $data['Partial_permanent_support_conditions'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Partial_permanent_support_conditions']=="K" ?
                        $data['Partial_permanent_support_conditions'] : ''}}</td>
                    <td style="font-size:10px;">{{$data['Partial_permanent_support_conditions']=="E" ?
                        $data['Partial_permanent_support_conditions'] : ''}}</td>
                </tr>
                <tr>
    ...
    <div class="tableDiv paddingTable">
        <div style="background:gray; padding: 12px; margin-top: 10px; color: white;">
            ...
            <p style="margin: 0;font-size:10px;">I confirm that this is a true record of my experience and
                qualifications. <br>
            ...
            <tbody>
                <tr style="min-height: 150px;">
                    <td style="width: 200px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size: 12px;">Print name</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:10px;"> {{$data['print_name']}}</td>
                </tr>
                <tr style="height: 150px;">
                    <td style="width: 200px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size: 12px;">Job title</b></label>
                    </td>
                ...
                <tr style="height: 150px;">
                    <td style="width: 200px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size: 12px;">Date</b></label>
                    </td>
                ...
                <tr>
                    <td style="width: 200px;background:gray;color:white">
                        <label for=""
                            style="float: left;width: 200px; font-size: 14px; padding: 10px; display: grid; align-items: center; background: gray !important;  color: #fff; margin: 0px;"><b
                                style="font-size: 12px;">Signature</b></label>
                    </td>
                    <td colspan="3" style="width: 300px; font-size:10px;">
                        @if($data['signtype']=='1')
                        {{ucwords($signature)}}
