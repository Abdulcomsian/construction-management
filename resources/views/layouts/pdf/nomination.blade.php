        ...
        <table>
            <tbody>
                ...
                <td style="width: 400px;background:gray;color:white">
                    ...
                    <td colspan="3" style="width: 300px; font-size:11px;">{{$data['nominated_person_employer'] ?? ''}}</td>
                </tr>
                <tr style="height: 150px;">
                <td style="width: 400px;background:gray;color:white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="font-size:10px;">Piling mats & working platforms</td>
                             <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="N" ? $data['Piling_mats_working_platforms'] : ''}}</td>
                            <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="A" ? $data['Piling_mats_working_platforms'] : ''}}</td>
                            <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="K" ? $data['Piling_mats_working_platforms'] : ''}}</td>
                            <td style="font-size:10px;">{{$data['Piling_mats_working_platforms']=="E" ? $data['Piling_mats_working_platforms'] : ''}}</td>
                        </tr>
                        <tr>
