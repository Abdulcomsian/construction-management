   ...
   <div style="padding: 0px; width: 100%; max-width: 70%; margin: auto;">
      ...
      <div class="tableDiv paddingTable" style="margin: 20px 0px;">
         <table>
            <tbody>
               <tr>
                  <td style="width:5%;background:gray;color:white; " rowspan="4">Footings</td>
               ...
               <tr>
                  <td style="width:5%;background:gray;color:white; " rowspan="3">Lodges</td>
                  <td style="width:30%;background:gray;color:white;">
                     <label style="border: 1px solid black; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background-color: #bfbfbf; color: black;  margin: 0px;">
               ...
               <tr>
                  <td style="width:5%;background:gray;color:white; " rowspan="3">GuardRails</td>
                  <td style="width:30%;background:gray;color:white;">
                     <label style="border: 1px solid black; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background-color: #bfbfbf; color: black;  margin: 0px;">
               ...
               <tr>
                  <td style="width:5%;background:gray;color:white; " rowspan="3">Couplings</td>
                  <td style="width:30%;background:gray;color:white;">
                     <label style="border: 1px solid black; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background-color: #bfbfbf; color: black;  margin: 0px;">
                        <b style="font-size: 12px;"> Wrong fittings?
                        </b>
               ...
               <tr>
                  ...
                  <td style="width:30%;background:gray;color:white;">
                     <label style="border: 1px solid black; height: 70px; font-size: 14px; padding: 10px; display: grid; align-items: center; background-color: #bfbfbf; color: black;  margin: 0px;">
                        <b style="font-size: 12px;">Partially Removed?
                        </b>
                     </label>
                  </td>
                  <td style="width:10%;">
