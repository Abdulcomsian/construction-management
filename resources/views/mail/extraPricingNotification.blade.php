                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px"><span class="im">
                                                                   ...
                                                                   <p>Admin Designer added an extra pricing</p>
                                                                   <p>
                                                                       {{-- <a href="{{url('Estimator/estimator')}}">View Estimate</a> --}}
                                                                       <a href="{{route('estimator.designer_client',$temporary_work_id.'/?mail='.$email.'&code='.Crypt::encrypt($code))}}">View Extra Price</a>
                                                                   </p>
