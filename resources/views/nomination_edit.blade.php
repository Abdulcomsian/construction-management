            ...
            <div class="card shadow-lg">
                ...
                <form action="{{url('Nomination/nomination-update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table nom_table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="project_manager"
                                            value="{{$nomination->project_manager ?? ''}}" required></td>
                                </tr>
                                <tr>
                                    <td>Nominated person (Your name)</td>
                                    <td><input type="text" name="nominated_person"
                                            value="{{$nomination->nominated_person ?? ''}}" required></td>
                                </tr>
                                <tr>
                                    <td>Nominated person’s employer</td>
                                    <td><input type="text" name="nominated_person_employer"
                                            value="{{$nomination->nominated_person_employer ?? ''}}" required></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="description_of_role"
                                            value="{{$nomination->description_of_role}}"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="Description_limits_authority"
                                            value="{{$nomination->Description_limits_authority}}"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="authority_issue_permit"
                                            value="{{$nomination->authority_issue_permit}}"></td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table tableBordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="Temporary_offices" value="N"
                                            {{$data['Temporary_offices']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_offices" value="A"
                                            {{$data['Temporary_offices']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_offices" value="K"
                                            {{$data['Temporary_offices']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_offices" value="E"
                                            {{$data['Temporary_offices']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Sign boards</td>
                                    <td><input type="radio" name="Sign_boards" value="N" {{$data['Sign_boards']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Sign_boards" value="A" {{$data['Sign_boards']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Sign_boards" value="K" {{$data['Sign_boards']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Sign_boards" value="E" {{$data['Sign_boards']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Hoardings</td>
                                    <td><input type="radio" name="Hoardings" value="N" {{$data['Hoardings']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Hoardings" value="A" {{$data['Hoardings']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Hoardings" value="K" {{$data['Hoardings']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Hoardings" value="E" {{$data['Hoardings']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Access gantries</td>
                                    <td><input type="radio" name="Access_gantries" value="N"
                                            {{$data['Access_gantries']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Access_gantries" value="A"
                                            {{$data['Access_gantries']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Access_gantries" value="K"
                                            {{$data['Access_gantries']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Access_gantries" value="E"
                                            {{$data['Access_gantries']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Fuel storage</td>
                                    <td><input type="radio" name="Fuel_storage" value="N" {{$data['Fuel_storage']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Fuel_storage" value="A" {{$data['Fuel_storage']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Fuel_storage" value="K" {{$data['Fuel_storage']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Fuel_storage" value="E" {{$data['Fuel_storage']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Temporary roads</td>
                                    <td><input type="radio" name="Temporary_roads" value="N"
                                            {{$data['Temporary_roads']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_roads" value="A"
                                            {{$data['Temporary_roads']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_roads" value="K"
                                            {{$data['Temporary_roads']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_roads" value="E"
                                            {{$data['Temporary_roads']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Barriers</td>
                                    <td><input type="radio" name="Barriers" value="N" {{$data['Barriers']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Barriers" value="A" {{$data['Barriers']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Barriers" value="K" {{$data['Barriers']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Barriers" value="E" {{$data['Barriers']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Welfare facilities</td>
                                    <td><input type="radio" name="Welfare_facilities" value="N"
                                            {{$data['Welfare_facilities']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Welfare_facilities" value="A"
                                            {{$data['Welfare_facilities']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Welfare_facilities" value="K"
                                            {{$data['Welfare_facilities']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Welfare_facilities" value="E"
                                            {{$data['Welfare_facilities']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Precast facilities</td>
                                    <td><input type="radio" name="Precast_facilities" value="N"
                                            {{$data['Precast_facilities']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Precast_facilities" value="A"
                                            {{$data['Precast_facilities']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Precast_facilities" value="K"
                                            {{$data['Precast_facilities']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Precast_facilities" value="E"
                                            {{$data['Precast_facilities']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Access bridges</td>
                                    <td><input type="radio" name="Access_bridges" value="N"
                                            {{$data['Access_bridges']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Access_bridges" value="A"
                                            {{$data['Access_bridges']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Access_bridges" value="K"
                                            {{$data['Access_bridges']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Access_bridges" value="E"
                                            {{$data['Access_bridges']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <!-- 2 -->
                                @php
                                ...
                                <tr>
                                    ...
                                    <td>Tube & fitting</td>
                                    <td><input type="radio" name="Tube_fitting" value="N" {{$data['Tube_fitting']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Tube_fitting" value="A" {{$data['Tube_fitting']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Tube_fitting" value="K" {{$data['Tube_fitting']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Tube_fitting" value="E" {{$data['Tube_fitting']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>System scaffolding</td>
                                    <td><input type="radio" name="System_scaffolding" value="N"
                                            {{$data['System_scaffolding']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="System_scaffolding" value="A"
                                            {{$data['System_scaffolding']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="System_scaffolding" value="K"
                                            {{$data['System_scaffolding']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="System_scaffolding" value="E"
                                            {{$data['System_scaffolding']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>System staircases</td>
                                    <td><input type="radio" name="System_staircases" value="N"
                                            {{$data['System_staircases']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="System_staircases" value="A"
                                            {{$data['System_staircases']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="System_staircases" value="K"
                                            {{$data['System_staircases']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="System_staircases" value="E"
                                            {{$data['System_staircases']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Temporary roofs</td>
                                    <td><input type="radio" name="Temporary_roofs" value="N"
                                            {{$data['Temporary_roofs']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_roofs" value="A"
                                            {{$data['Temporary_roofs']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_roofs" value="K"
                                            {{$data['Temporary_roofs']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_roofs" value="E"
                                            {{$data['Temporary_roofs']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Loading bays</td>
                                    <td><input type="radio" name="Loading_bays" value="N" {{$data['Loading_bays']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Loading_bays" value="A" {{$data['Loading_bays']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Loading_bays" value="K" {{$data['Loading_bays']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Loading_bays" value="E" {{$data['Loading_bays']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Chute support</td>
                                    <td><input type="radio" name="Chute_support" value="N" {{$data['Chute_support']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Chute_support" value="A" {{$data['Chute_support']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Chute_support" value="K" {{$data['Chute_support']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Chute_support" value="E" {{$data['Chute_support']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Mobile towers</td>
                                    <td><input type="radio" name="Mobile_towers" value="N" {{$data['Mobile_towers']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mobile_towers" value="A" {{$data['Mobile_towers']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mobile_towers" value="K" {{$data['Mobile_towers']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mobile_towers" value="E" {{$data['Mobile_towers']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Edge protection</td>
                                    <td><input type="radio" name="Edge_protection" value="N"
                                            {{$data['Edge_protection']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Edge_protection" value="A"
                                            {{$data['Edge_protection']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Edge_protection" value="K"
                                            {{$data['Edge_protection']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Edge_protection" value="E"
                                            {{$data['Edge_protection']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Suspension systems</td>
                                    <td><input type="radio" name="Suspension_systems" value="N"
                                            {{$data['Suspension_systems']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Suspension_systems" value="A"
                                            {{$data['Suspension_systems']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Suspension_systems" value="K"
                                            {{$data['Suspension_systems']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Suspension_systems" value="E"
                                            {{$data['Suspension_systems']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <!-- 3 -->
                                @php
                                ...
                                <tr>
                                    ...
                                    <td>Formwork</td>
                                    <td><input type="radio" name="Formwork" value="N" {{$data['Formwork']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Formwork" value="A" {{$data['Formwork']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Formwork" value="K" {{$data['Formwork']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Formwork" value="E" {{$data['Formwork']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Falsework</td>
                                    <td><input type="radio" name="Falsework" value="N" {{$data['Formwork']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Falsework" value="A" {{$data['Formwork']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Falsework" value="K" {{$data['Formwork']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Falsework" value="E" {{$data['Formwork']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Back propping</td>
                                    <td><input type="radio" name="Back_propping" value="N" {{$data['Back_propping']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Back_propping" value="A" {{$data['Back_propping']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Back_propping" value="K" {{$data['Back_propping']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Back_propping" value="E" {{$data['Back_propping']=="E"
                                            ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Support systems</td>
                                    <td><input type="radio" name="Support_systems" value="N"
                                            {{$data['Support_systems']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Support_systems" value="A"
                                            {{$data['Support_systems']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Support_systems" value="K"
                                            {{$data['Support_systems']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Support_systems" value="E"
                                            {{$data['Support_systems']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <!-- 4 -->
                                @php
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="Crane_supports_foundations" value="N"
                                            {{$data['Crane_supports_foundations']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Crane_supports_foundations" value="A"
                                            {{$data['Crane_supports_foundations']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Crane_supports_foundations" value="K"
                                            {{$data['Crane_supports_foundations']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Crane_supports_foundations" value="E"
                                            {{$data['Crane_supports_foundations']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Hoist ties & foundations</td>
                                    <td><input type="radio" name="Hoist_ties_foundations" value="N"
                                            {{$data['Hoist_ties_foundations']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Hoist_ties_foundations" value="A"
                                            {{$data['Hoist_ties_foundations']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Hoist_ties_foundations" value="K"
                                            {{$data['Hoist_ties_foundations']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Hoist_ties_foundations" value="E"
                                            {{$data['Hoist_ties_foundations']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Mast climbers & foundations</td>
                                    <td><input type="radio" name="Mast_climbers_foundations" value="N"
                                            {{$data['Mast_climbers_foundations']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mast_climbers_foundations" value="A"
                                            {{$data['Mast_climbers_foundations']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mast_climbers_foundations" value="K"
                                            {{$data['Mast_climbers_foundations']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mast_climbers_foundations" value="E"
                                            {{$data['Mast_climbers_foundations']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Mobile crane foundations</td>
                                    <td><input type="radio" name="Mobile_crane_foundations" value="N"
                                            {{$data['Mobile_crane_foundations']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mobile_crane_foundations" value="A"
                                            {{$data['Mobile_crane_foundations']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mobile_crane_foundations" value="K"
                                            {{$data['Mobile_crane_foundations']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Mobile_crane_foundations" value="E"
                                            {{$data['Mobile_crane_foundations']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Piling mats & working platforms</td>
                                    <td><input type="radio" name="Piling_mats_working_platforms" value="N"
                                            {{$data['MPiling_mats_working-platforms']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Piling_mats_working_platforms" value="A"
                                            {{$data['MPiling_mats_working-platforms']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Piling_mats_working_platforms" value="K"
                                            {{$data['MPiling_mats_working-platforms']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Piling_mats_working_platforms" value="E"
                                            {{$data['MPiling_mats_working-platforms']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Silo bases</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="Lifting_handling_devices" value="N"
                                            {{$data['Lifting_handling_devices']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Lifting_handling_devices" value="A"
                                            {{$data['Lifting_handling_devices']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Lifting_handling_devices" value="K"
                                            {{$data['Lifting_handling_devices']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Lifting_handling_devices" value="E"
                                            {{$data['Lifting_handling_devices']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <!-- 5 -->
                                @php
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="Excavation_support" value="N"
                                            {{$data['Excavation_support']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Excavation_support" value="A"
                                            {{$data['Excavation_support']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Excavation_support" value="K"
                                            {{$data['Excavation_support']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Excavation_support" value="E"
                                            {{$data['Excavation_support']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Cofferdams</td>
                                    <td><input type="radio" name="Cofferdams" value="N" {{$data['Cofferdams']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Cofferdams" value="A" {{$data['Cofferdams']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Cofferdams" value="K" {{$data['Cofferdams']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Cofferdams" value="E" {{$data['Cofferdams']=="E"
                                            ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Embankment/ bunds</td>
                                    <td><input type="radio" name="Embankment_bunds" value="N"
                                            {{$data['Embankment_bunds']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Embankment_bunds" value="A"
                                            {{$data['Embankment_bunds']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Embankment_bunds" value="K"
                                            {{$data['Embankment_bunds']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Embankment_bunds" value="E"
                                            {{$data['Embankment_bunds']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Ground anchor/ soil nailing</td>
                                    <td><input type="radio" name="Ground_anchor_soil_nailing" value="N"
                                            {{$data['Ground_anchor_soil_nailing']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Ground_anchor_soil_nailing" value="A"
                                            {{$data['Ground_anchor_soil_nailing']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Ground_anchor_soil_nailing" value="K"
                                            {{$data['Ground_anchor_soil_nailing']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Ground_anchor_soil_nailing" value="E"
                                            {{$data['Ground_anchor_soil_nailing']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Open excavations</td>
                                    <td><input type="radio" name="Open_excavations" value="N"
                                            {{$data['Open_excavations']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Open_excavations" value="A"
                                            {{$data['Open_excavations']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Open_excavations" value="K"
                                            {{$data['Open_excavations']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Open_excavations" value="E"
                                            {{$data['Open_excavations']=="E" ? 'checked' :''}}></td>
                                </tr>
                                <tr>
                                    <td>Dewatering</td>
                                    <td><input type="radio" name="Dewatering" value="N" {{$data['Dewatering']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Dewatering" value="A" {{$data['Dewatering']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Dewatering" value="K" {{$data['Dewatering']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Dewatering" value="E" {{$data['Dewatering']=="E"
                                            ? 'checked' :''}}></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="Existing_structures_during_construction" value="N"
                                            {{$data['Existing_structures_during_construction']=="N" ? 'checked' :''}}>
                                    </td>
                                    <td><input type="radio" name="Existing_structures_during_construction" value="A"
                                            {{$data['Existing_structures_during_construction']=="A" ? 'checked' :''}}>
                                    </td>
                                    <td><input type="radio" name="Existing_structures_during_construction" value="K"
                                            {{$data['Existing_structures_during_construction']=="K" ? 'checked' :''}}>
                                    </td>
                                    <td><input type="radio" name="Existing_structures_during_construction" value="E"
                                            {{$data['Existing_structures_during_construction']=="E" ? 'checked' :''}}>
                                    </td>

                                </tr>
                                <tr>
                                    <td>New structures during construction</td>
                                    <td><input type="radio" name="New_structures_during_construction" value="N"
                                            {{$data['New_structures_during_construction']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="New_structures_during_construction" value="A"
                                            {{$data['New_structures_during_construction']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="New_structures_during_construction" value="K"
                                            {{$data['New_structures_during_construction']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="New_structures_during_construction" value="E"
                                            {{$data['New_structures_during_construction']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Structural steelwork erection</td>
                                    <td><input type="radio" name="Structural_steelwork_erection" checked value="N"
                                            {{$data['Structural_steelwork_erection']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Structural_steelwork_erection" value="A"
                                            {{$data['Structural_steelwork_erection']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Structural_steelwork_erection" value="K"
                                            {{$data['Structural_steelwork_erection']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Structural_steelwork_erection" value="E"
                                            {{$data['Structural_steelwork_erection']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Needling</td>
                                    <td><input type="radio" name="Needling" value="N" {{$data['Needling']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Needling" value="A" {{$data['Needling']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Needling" value="K" {{$data['Needling']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Needling" value="E" {{$data['Needling']=="E"
                                            ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Temporary underpinning</td>
                                    <td><input type="radio" name="Temporary_underpinning" value="N"
                                            {{$data['Temporary_underpinning']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_underpinning" value="A"
                                            {{$data['Temporary_underpinning']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_underpinning" value="K"
                                            {{$data['Temporary_underpinning']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Temporary_underpinning" value="E"
                                            {{$data['Temporary_underpinning']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Façade system</td>
                                    <td><input type="radio" name="Façade_system" value="N" {{$data['Façade_system']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Façade_system" value="A" {{$data['Façade_system']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Façade_system" value="K" {{$data['Façade_system']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Façade_system" value="E" {{$data['Façade_system']=="E"
                                            ? 'checked' :''}}></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="Partial_permanent_support_conditions" value="N"
                                            {{$data['Partial_permanent_support_conditions']=="N" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Partial_permanent_support_conditions" value="A"
                                            {{$data['Partial_permanent_support_conditions']=="A" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Partial_permanent_support_conditions" value="K"
                                            {{$data['Partial_permanent_support_conditions']=="K" ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Partial_permanent_support_conditions" value="E"
                                            {{$data['Partial_permanent_support_conditions']=="E" ? 'checked' :''}}></td>

                                </tr>
                                <tr>
                                    <td>Demolitions</td>
                                    <td><input type="radio" name="Demolitions" value="N" {{$data['Demolitions']=="N"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Demolitions" value="A" {{$data['Demolitions']=="A"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Demolitions" value="K" {{$data['Demolitions']=="K"
                                            ? 'checked' :''}}></td>
                                    <td><input type="radio" name="Demolitions" value="E" {{$data['Demolitions']=="E"
                                            ? 'checked' :''}}></td>
                            ...
                            <table class="table nom_table mt-0 table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="print_name" value="{{$nomination->print_name}}">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox2">Pdf
                                                    signature?</label>
                                            </div>
                        ...
                        <button type="submit" class="btn submitbtn btn-secondary" disabled>update</button>
                    </div>
