...
<table style="width:100%">
  <tr >
    <td style="border-right:1px solid black" > 
       <div class="company-name"> Consulting Temporary Works Engineers </div>
...
<div class="options" style="margin-left:5%">
        ...
        <table style="width:100%">
    <tr>
        <td style="width:30%">TWF 2012-01-DEC13 </td>
        <td> Hoardings - a Guide to good practice</td>
    </tr>
    <tr>
        <td>BS 5975:2019</td>
        <td> Temporary Works Procedures</td>
    </tr>
    <tr>
        <td>BS 1722-5:2006</td>
        <td> Fences. Specification for close-boarded fences and wooden palisade fences</td>
    </tr>
    <tr>
        <td>BS 5975:2019</td>
        <td> Temporary Works Procedures</td>
