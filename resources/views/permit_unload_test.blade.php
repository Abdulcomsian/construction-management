            ...
            <div class="card-body pt-0">
                <form id="permitunload" action="{{route('permit.unload.save')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="inputDiv">
                                <label style="color:black; bottom: 52px">TWC to define the extents, limits and controls for this PTS (where
                                    applicable)</label>
                                <textarea name="twc_control_pts" class="twcTextArea" rows="2" style="width:100%;"></textarea>
                            </div>

                            <div class="inputDiv">
                                <label style="color:black; bottom: 52px">Back-propping and additional requirements; limitations and
